...
CONSTRAINT FOREIGN KEY (StreamPlatformID) REFERENCES StreamPlatform (StreamPlatformID) ON DELETE CASCADE
);
...
CREATE TABLE Event (
  ...
  PRIMARY KEY (EventID),
CONSTRAINT FOREIGN KEY (EventTypeID) REFERENCES EventType (EventTypeID) ON DELETE CASCADE,
