...
VALUES (1, "Feelsofly", "Arya", "Stark", "Filsoofi", "2016-08-04", true, false, "arya.filsoofi@gmail.com", "123-456-7890", true);

INSERT INTO Users (UserID, UserName, FirstName, MiddleName, LastName, StartDate, ActiveStatus, PayStatus, Email, Phone, ChatStatus) 
VALUES (2, "DanZee", "Dan", "Luigi", "Zee", "2017-12-12", false, false, "dan.a.to.zee@hotmail.com", "235-735-1746", false);

INSERT INTO Users (UserID, UserName, FirstName, MiddleName, LastName, StartDate, ActiveStatus, PayStatus, Email, Phone, ChatStatus) 
VALUES (3, "Bond", "Nicholas", "James", "Bond", "2019-04-01", true, true, "lemon-bond@notaspy.ca", "007-007-0007", true);

INSERT INTO Users (UserID, UserName, FirstName, MiddleName, LastName, StartDate, ActiveStatus, PayStatus, Email, Phone, ChatStatus) 
VALUES (4, "LouiseIV", "Louis", "Eduardo", "Lee", "2018-01-31", false, true, "MacsRule@Gmail.com", "231-643-7321", true);

INSERT INTO Users (UserID, UserName, FirstName, MiddleName, LastName, StartDate, ActiveStatus, PayStatus, Email, Phone, ChatStatus) 
VALUES (5, "xXLenaXx", "Lena", "La", "Lai", "2016-12-31", true, false, "Lllllena@sympatico.ca", "234-543-9210", true);

INSERT INTO Users (UserID, UserName, FirstName, MiddleName, LastName, StartDate, ActiveStatus, PayStatus, Email, Phone, ChatStatus) 
VALUES (6, "Skiph", "Ryan", "Benjamin", "Gee", "2019-05-09", false, false, "abcdefgee@Gmail.com", "520-356-4325", true);

INSERT INTO Users (UserID, UserName, FirstName, MiddleName, LastName, StartDate, ActiveStatus, PayStatus, Email, Phone, ChatStatus) 
VALUES (7, "LMFAO", "Mohammed", "Muhammad", "Muhammed", "2015-11-11", false, true, "TheOtherMuhammed@Mohammad.com", "127-234-6345", false);

INSERT INTO Users (UserID, UserName, FirstName, MiddleName, LastName, StartDate, ActiveStatus, PayStatus, Email, Phone, ChatStatus) 
VALUES (8, "Putin", "Vladimir", "Ivan", "Slavinski", "2017-09-08", true, true, "real.Slav@slavsRUs.rus", "111-111-1111", false);

INSERT INTO Users (UserID, UserName, FirstName, MiddleName, LastName, StartDate, ActiveStatus, PayStatus, Email, Phone, ChatStatus) 
VALUES (9, "Skywalker", "Kyle", "Brett", "Morgan", "2018-02-21", false, true, "whiteDude@hotmail.com", "632-534-7693", true);

INSERT INTO Users (UserID, UserName, FirstName, MiddleName, LastName, StartDate, ActiveStatus, PayStatus, Email, Phone, ChatStatus) 
VALUES (10, "$Money$", "Jeff", "Amazon", "Bezos", "2019-01-01", true, true, "richerThanU@amazon.com", "098-765-4321", false);
...
VALUES (1, "Fortnite", true, 1);

INSERT INTO Games (GameID, GameName, SingleMulti, GenreID)
VALUES (2, "League of Legends", true, 3);

INSERT INTO Games (GameID, GameName, SingleMulti, GenreID)
VALUES (3, "Dota 2", true, 3);

INSERT INTO Games (GameID, GameName, SingleMulti, GenreID)
VALUES (4, "Black Ops IV", true, 2);

INSERT INTO Games (GameID, GameName, SingleMulti, GenreID)
VALUES (5, "CS:GO", true, 2);

INSERT INTO Games (GameID, GameName, SingleMulti, GenreID)
VALUES (6, "World of Warcraft", true, 4);

INSERT INTO Games (GameID, GameName, SingleMulti, GenreID)
VALUES (7, "Assassin's Creed Odyssey", false, 5);

INSERT INTO Games (GameID, GameName, SingleMulti, GenreID)
VALUES (8, "Apex Legends", true, 1);

INSERT INTO Games (GameID, GameName, SingleMulti, GenreID)
VALUES (9, "Super Smash Bros", true, 6);

INSERT INTO Games (GameID, GameName, SingleMulti, GenreID)
VALUES (10, "Metroid Prime", false, 7);
